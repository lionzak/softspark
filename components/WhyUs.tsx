...
export default function WhyUs() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6">
      <h1 className="text-4xl md:text-5xl font-extrabold text-blue-800 mb-8 animate-bounce">
        Why Choose SoftSpark for Web Development?
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card p-6 bg-white rounded-lg shadow-lg transform hover:shadow-2xl transition-all duration-300">
